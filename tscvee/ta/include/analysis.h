...
{
    stack->top_item = (struct uint256_t *)TEE_Malloc(sizeof(struct uint256_t), TEE_MALLOC_FILL_ZERO);
    stack->m_bottom = (struct uint256_t *)TEE_Malloc(sizeof(struct uint256_t), TEE_MALLOC_FILL_ZERO);
}
